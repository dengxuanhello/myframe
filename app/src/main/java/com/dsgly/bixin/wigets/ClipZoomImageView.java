...
public class ClipZoomImageView extends ImageView implements
        OnScaleGestureListener, OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
...
//            mVerticalPadding = (getHeight() - (getWidth() - 2 * mHorizontalPadding)) / 2;
            float rectHeight = (getWidth() - mHorizontalPadding * 2) / ClipImageLayout.SCALE;
            mVerticalPadding = (int) (getHeight() - rectHeight) / 2;
            int width = getWidth();
            int height = getHeight();
            // 拿到图片的宽和高
            int dw = d.getIntrinsicWidth();
            int dh = d.getIntrinsicHeight();
//            Log.e("Width+Height", dw + ":" + dh);
//            Log.e("getWidth+getHeight", (getWidth() - mHorizontalPadding * 2) + ":" + (getHeight() - mVerticalPadding * 2));
            float scale = 1.0f;
