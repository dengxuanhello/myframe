...
import static com.alibaba.fastjsonex.util.ASMUtils.getDesc;
import static com.alibaba.fastjsonex.util.ASMUtils.getType;
...
import com.alibaba.fastjsonex.asm.ClassWriter;
import com.alibaba.fastjsonex.asm.FieldVisitor;
import com.alibaba.fastjsonex.asm.Label;
import com.alibaba.fastjsonex.asm.MethodVisitor;
...
import com.alibaba.fastjsonex.parser.JSONScanner;
import com.alibaba.fastjsonex.parser.JSONToken;
import com.alibaba.fastjsonex.parser.ParseContext;
import com.alibaba.fastjsonex.parser.ParserConfig;
import com.alibaba.fastjsonex.parser.SymbolTable;
import com.alibaba.fastjsonex.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
            ...
            if (fieldClass == boolean.class) {
                ...
                if (actualTypeArgument instanceof Class) {
                    ...
                    if (itemClass == String.class) {
                        mw.visitLdcInsn(com.alibaba.fastjsonex.asm.Type.getType(getDesc(fieldClass))); // cast
...
//         mw.visitMethodInsn(INVOKEVIRTUAL, getType(java.io.PrintStream.class), "println", "(I)V");
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.alibaba.fastjsonex.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getConfig", "()"
                                                                                         + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.alibaba.fastjsonex.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
