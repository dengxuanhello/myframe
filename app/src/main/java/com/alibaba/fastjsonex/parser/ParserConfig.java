...
import com.alibaba.fastjsonex.asm.ASMException;
import com.alibaba.fastjsonex.parser.deserializer.ASMDeserializerFactory;
import com.alibaba.fastjsonex.parser.deserializer.ASMJavaBeanDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ArrayDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ArrayListStringDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ArrayListStringFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ArrayListTypeDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ArrayListTypeFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.AtomicIntegerArrayDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.AtomicLongArrayDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.AutowiredObjectDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.BigDecimalDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.BigIntegerDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.BooleanDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.BooleanFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.CalendarDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.CharArrayDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.CharacterDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.CharsetDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ClassDerializer;
import com.alibaba.fastjsonex.parser.deserializer.CollectionDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.DateDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.DateFormatDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.DefaultFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.DefaultObjectDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.DoubleFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.EnumDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.FieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.FileDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.FloatDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.FloatFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.InetAddressDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.InetSocketAddressDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.IntegerDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.IntegerFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.JSONArrayDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.JSONObjectDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.JavaBeanDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.JavaObjectDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.LocaleDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.LongDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.LongFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.MapDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.NumberDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ObjectDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.PatternDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.SqlDateDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.StackTraceElementDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.StringDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.StringFieldDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.ThrowableDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.TimeDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.TimeZoneDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.TimestampDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.URIDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.URLDeserializer;
import com.alibaba.fastjsonex.parser.deserializer.UUIDDeserializer;
import com.alibaba.fastjsonex.util.ASMClassLoader;
import com.alibaba.fastjsonex.util.ASMUtils;
import com.alibaba.fastjsonex.util.DeserializeBeanInfo;
import com.alibaba.fastjsonex.util.FieldInfo;
import com.alibaba.fastjsonex.util.IdentityHashMap;
import com.alibaba.fastjsonex.util.ServiceLoader;
...
public class ParserConfig {
    ...
    private final DefaultObjectDeserializer defaultSerializer = new DefaultObjectDeserializer();
    ...
    public FieldDeserializer createFieldDeserializerWithoutASM(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo) {
        ...
        // XXX added by zitian.zhang 2012.11.26
