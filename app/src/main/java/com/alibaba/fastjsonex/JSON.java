...
import com.alibaba.fastjsonex.serializer.JSONSerializer;
import com.alibaba.fastjsonex.serializer.NameFilter;
import com.alibaba.fastjsonex.serializer.PropertyFilter;
import com.alibaba.fastjsonex.serializer.PropertyPreFilter;
import com.alibaba.fastjsonex.serializer.SerializeConfig;
import com.alibaba.fastjsonex.serializer.SerializeFilter;
import com.alibaba.fastjsonex.serializer.SerializeWriter;
import com.alibaba.fastjsonex.serializer.SerializerFeature;
import com.alibaba.fastjsonex.serializer.ValueFilter;
import com.alibaba.fastjsonex.util.FieldInfo;
import com.alibaba.fastjsonex.util.IOUtils;
import com.alibaba.fastjsonex.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= com.alibaba.fastjsonex.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= com.alibaba.fastjsonex.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= com.alibaba.fastjsonex.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= com.alibaba.fastjsonex.serializer.SerializerFeature.SortField.getMask();
        // features |= com.alibaba.fastjsonex.serializer.SerializerFeature.WriteTabAsSpecial.getMask();
        // features |= com.alibaba.fastjsonex.serializer.SerializerFeature.WriteSlashAsSpecial.getMask();
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (com.alibaba.fastjsonex.serializer.SerializerFeature feature : features) {
    ...
    public static final Object toJSON(Object javaObject, ParserConfig mapping) {
        ...
        try {
            ...
            // XXX added by zitian.zhang
            JSONType annotation = clazz.getAnnotation(JSONType.class);
            JSONObject json = new JSONObject(getters.size(), annotation != null && annotation.orders() != null);
            // END

            for (FieldInfo field : getters) {
                Object value = field.get(javaObject);
                Object jsonValue = toJSON(value, mapping);
